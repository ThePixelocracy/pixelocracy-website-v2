...
// (the remaining two pillar pages, etc.) are validated and promoted — it
 ...
 * three V4 pillar pages (Strategy & Advisory, Data AI & Automation,
 * Engineering & Security) join it here. Every other existing route (V2, V3,
 * the remaining /services/[slug] pages) keeps the exact same <Navigation/>
