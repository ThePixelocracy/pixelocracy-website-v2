...
1. The canonical authority is: `knowledge/08_v4_design_system.md` — extracted directly from the approved, locked V4 implementation (`src/app/page.tsx`, the real homepage, and `src/components/v4/`). Where code and this document disagree, the code is right; fix the document.
